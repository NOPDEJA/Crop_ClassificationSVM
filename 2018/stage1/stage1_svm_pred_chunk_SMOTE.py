"""stage1_svm_pred_chunk_SMOTE.py
...
# Outputs
OUT_MODEL = "stage1_svm_pred_chunk_SMOTE.joblib"
OUT_THRESH = "stage1_thresholds_pred_chunk_SMOTE.json"
OUT_REPORT = "stage1_report_pred_chunk_SMOTE.csv"
OUT_PRED_NPY = "stage1_pred_SMOTE.npy"
OUT_PROB_NPY = "stage1_prob_SMOTE.npy"

# mapping sets
economic_crops = {2101,2204,2205,2302,2303,2403,2404,2405,2407,2413,2416,2419,2420}
water_code = {4101,4102,4103,4201,4202,4203}
forest_code = {3100,3101,3200,3201,3300,3301,3401,3501}  # <--- new forest set
...
if __name__ == "__main__":
    ...
    print("Train distribution after SMOTETomek:", train_final_counts)
