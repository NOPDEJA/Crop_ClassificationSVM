...
CAP_ECON = 30000      # maximum econ samples to keep (set None to keep all)
CAP_WATER = 15000     # maximum water samples
CAP_OTHERS = 30000    # maximum others samples
...
OUT_MODEL = "stage1_svm_improved.joblib"
OUT_REPORT_CSV = "stage1_svm_improved_report.csv"
OUT_THRESH_JSON = "stage1_thresholds.json"
