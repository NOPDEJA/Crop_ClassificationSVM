...
CAP_OTHERS = 30000            # cap for others (None to keep all)
...
OUT_MODEL = "stage1_svm_increase_econ.joblib"
OUT_REPORT_CSV = "stage1_svm_increase_econ_report.csv"
OUT_THRESH_JSON = "stage1_increase_econ_thresholds.json"
...
if __name__ == "__main__":
    print("=== Stage-1 SVM (increase econ support) ===")
