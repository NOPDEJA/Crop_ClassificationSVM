# stage2_svm_smote.py  (updated for subclass/hierarchical Stage-2)
"""
...
# Outputs
OUT_MODEL = "stage2_SMOTE2_model.joblib"
OUT_REPORT = "stage2_SMOTE2_report.csv"
OUT_STATS_LU = "stage2_SMOTE2_indicator_stats_per_lu.csv"
OUT_STATS_GROUP = "stage2_SMOTE2_indicator_stats_per_group.csv"
OUT_TEST_PROB = "stage2_SMOTE2_test_prob.npy"
OUT_TEST_PRED = "stage2_SMOTE2_test_pred.npy"
OUT_META_JSON = "stage2_SMOTE2_subclass_meta.json"
...
if __name__ == "__main__":
    ...
    smt = SMOTETomek(random_state=RANDOM_STATE, n_jobs=N_JOBS)
    X_tr_bal, y_tr_bal = smt.fit_resample(X_tr, y_tr)
    print("After SMOTETomek:", Counter(y_tr_bal))
